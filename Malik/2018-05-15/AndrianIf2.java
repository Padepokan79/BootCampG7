...
public class AndrianIf2{
	public static void main(String[] args){
		...
		double gajiDuaA, gajiDuaB, gajiTigaA, gajiTigaB, gajiEmpatA, gajiEmpatB,tunjanganDuaA, tunjanganDuaB, tunjanganTigaA, tunjanganTigaB, tunjanganEmpatA, tunjanganEmpatB, persen;
		...
		if ( list.equals(golDuaA) ) {
			double pajak = persen*( gajiDuaA+tunjanganDuaA );
			...
			double pajak = persen*( gajiDuaB+tunjanganDuaB );
			...
			double pajak = persen*( gajiTigaA+tunjanganTigaA );
			...
			double pajak = persen*( gajiTigaB+tunjanganTigaB );
			...
			double pajak = persen*( gajiEmpatA+tunjanganEmpatA );
			...
			double pajak = persen*( gajiEmpatB+tunjanganEmpatB );
