/*
     ...
     * Programmer : Rizaldi
     * Created By : Rizaldi
     * Created At : 02 May 2018 10:30 AM     
     * Updated By : 
     * Updated At : 
*/
...
public class Ex7Drills2{
    public static void main( String[] args){
        ...
        keyboard.nextDouble();
        // ketika saya ketik "paris" muncul error = Exception in thread "main" java.util.InputMismatchException
        // ketika saya ketik "paris 23523" muncul error = Exception in thread "main" java.util.InputMismatchException
        // ketika saya ketik "123 456 678 789 678" = pertanyaan langsung skip. karena value angka masuk ke pertanyaan selanjutnya
