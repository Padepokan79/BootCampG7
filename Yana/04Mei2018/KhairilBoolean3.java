...
public class KhairilBoolean3{
	public static void main(String[] args){
		...
		hasil	= ( jenisTiket.equals("Y") && ( ( ( jenisKelamin.equals("L") || jenisKelamin.equals("P") ) && typeKelas.equals("T") && lamaTerbang > 30  || 
				  ( ( typeKelas.equals("D") || typeKelas.equals("F") ) && ( ( jenisKelamin.equals("P") && lamaTerbang >= 15 ) || ( jenisKelamin.equals("P") && lamaTerbang >= 20 ) ) ) ) );
