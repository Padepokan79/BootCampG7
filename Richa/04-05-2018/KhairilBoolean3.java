...
Updated Date/hour	: 4 Mei 2018/ 2.24
...
public class KhairilBoolean3 {
	public static void main  (String[] args) {
		...
		System.out.print ("Memiliki tiket kelas bisnis (Y/T)? ");
		bisnis = keyboard.next();
		...
		lounge = bisnis.equals("Y") && ((laki && !kelasT && terbang >= 20) || (perempuan &&  !kelasT  && terbang >= 15) || (kelasT && terbang >= 30));
