...
public class TugasArray10{
    public static void main(String[] args){
        ...
        Arrays.sort(arr1);
        System.out.println(" ");        
        System.out.println("nilai terbesar adalah : "+arr1[arr1.length-1]);
