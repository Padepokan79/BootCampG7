...
public class SistemAnalis extends Karyawan implements Gapok, Lembur, Tunjangan, BPJS, Pph{
	double gapok, uangLembur, uangTunjangan, gajiKotor, bpjsKesehatan, bpjsKetenagakerjaan, jumlahKeluarga;
	...
	public double gaji() {
		return (gajiKotor - pph() - potonganBPJS() );
	}
