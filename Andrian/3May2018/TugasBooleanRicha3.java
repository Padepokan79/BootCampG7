	...
	*/
	...
	public class TugasBooleanRicha3 {
		public static void main(String [] args){
			...
			int umursuami,umuristri,batasusia,batasbertengkar,batasgaji,bertengkar,gaji;
			boolean hasil;
			...
			hasil = (umursuami <= (umuristri+batasusia)) && bertengkar<=batasbertengkar && gaji>=batasgaji ;
