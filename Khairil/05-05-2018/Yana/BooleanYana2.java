...
class BooleanYana2 {
	public static void main(String[] args) {
		...
		qualified = ( (inputJK.equals(l) || inputJK.equals(p)) && ( inputIpkS1 + inputIpkS2 / 2 >= ipkMin ) && inputPend.equals(s2) && (inputAkreditasi.equals(akreditasiA) || inputAkreditasi.equals(akreditasiB)) );
